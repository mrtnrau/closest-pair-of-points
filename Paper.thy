...
Furthermore, Preparata and Shamos \cite{Computational-Geometry-An-Introduction:1985} as well as Ge \emph{et al.}
...
Ge \emph{et al.} \cite{Ge2006} prove a bound of @{text 3} for the number of points to be examined in the worst case.
